...
# Variables
lf_bg = 'Blue'  # Left Frame Background Color
rtf_bg = 'dark blue'  # Right Top Frame Background Color
...
Label(root, text=' MIT CSE DEPARTMENT LIBRARY MANAGEMENT SYSTEM', font=("Noto Sans CJK TC", 15, 'bold'), bg=btn_hlb_bg, fg='White').pack(side=TOP, fill=X)
